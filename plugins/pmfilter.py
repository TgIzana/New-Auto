...
#Deendayal403
        ...
        buttons = [[
            InlineKeyboardButton('× ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ ×', url="https://t.me/moviesall17")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="t.me/aayeinchat"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="t.me/aayein17")
       ],[
            InlineKeyboardButton('• sᴇʀɪᴇsғʟɪx •', url="https://t.me/moviesall17"),
            InlineKeyboardButton('• ᴍᴏᴠɪᴇғʟɪx •', url="https://t.me/moviesall17")
       ],[
            InlineKeyboardButton('• ᴀɴɪᴍᴇ ᴄʀᴜɪsᴇ •', url="https://t.me/gachan01")
       ],[ 
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                if settings["spell_check"]:
                    ai_sts = await m.edit('ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ, ɪsʜɪᴛᴀ ɪꜱ ᴄʜᴇᴄᴋɪɴɢ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ...')
                    is_misspelled = await ai_spell_check(chat_id = message.chat.id,wrong_name=search)
                    if is_misspelled:
                        await ai_sts.edit(f'<b>✅ɪsʜɪᴛᴀ sᴜɢɢᴇsᴛᴇᴅ <code> {is_misspelled}</code> \nsᴏ ɪᴍ sᴇᴀʀᴄʜɪɴɢ ғᴏᴛ <code>{is_misspelled}</code></b>')
